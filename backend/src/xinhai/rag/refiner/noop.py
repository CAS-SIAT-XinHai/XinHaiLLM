...
from xinhai.types.rag import XinHaiRAGRefinerTypes, XinHaiRAGRefinedResult, XinHaiRAGDocumentOut

logger = logging.getLogger(__name__)


@register_refiner(XinHaiRAGRefinerTypes.NOOP)
class NoopRefiner(XinHaiRAGRefinerBase):
    name = XinHaiRAGRefinerTypes.NOOP

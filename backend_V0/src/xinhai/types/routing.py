...
class XinHaiRoutingType(XinHaiRoutingTypeMixin, Enum):
    ...
    UNICAST = "[Unicast]", {
        XinHaiI18NLocales.CHINESE: "单播，可以给一个工具发送一个求助信息.",
        XinHaiI18NLocales.ENGLISH: "Unicast, You can send a help message to a tool."
    }
    ...
    END_CAST = "[EndCast]", {
        XinHaiI18NLocales.CHINESE: "不再使用工具获取信息，基于以上的信息，自己已经可以精确无误的解决该问题。",
        XinHaiI18NLocales.ENGLISH: "No longer need to use tools to obtain information, based on the above information, you can solve the problem accurately and without error."
    }

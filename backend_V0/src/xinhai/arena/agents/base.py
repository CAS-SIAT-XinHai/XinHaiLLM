...
class BaseAgent:
    ...
    def __init__(self, name, agent_id, role_description, llm, api_key, api_base,
                 ...
                 environment_id, controller_address, locale, allowed_routing_types,image_path=None,
                 max_retries=4,user_question=None):
    ...
    def get_routing_prompt(self, candidate_agents, **kwargs):
        ...
        return self.routing_prompt_template.format(user_question=self.user_question,
    ...
    @abstractmethod
    def step(self, routing, agents, image=None,**kwargs):
        """Get one step response"""
        pass
